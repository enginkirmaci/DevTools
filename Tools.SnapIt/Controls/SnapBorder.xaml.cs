...
using Tools.SnapIt.Controls.Extensions;
...
public partial class SnapBorder : UserControl
{
    ...
    public Line GetLine()
    {
        var line = SplitDirection == SplitDirection.Vertical ?
            new Line
            {
                Start = new Tools.SnapIt.Common.Graphics.Point((float)(Margin.Left + ReferenceBorder.Margin.Left), (float)(Margin.Top + ReferenceBorder.Margin.Top)),
                End = new Tools.SnapIt.Common.Graphics.Point((float)(Margin.Left + ReferenceBorder.Margin.Left), (float)(Margin.Top + ReferenceBorder.Margin.Top + Height))
            } :
            new Line
            {
                Start = new Tools.SnapIt.Common.Graphics.Point((float)(Margin.Left + ReferenceBorder.Margin.Left), (float)(Margin.Top + ReferenceBorder.Margin.Top)),
                End = new Tools.SnapIt.Common.Graphics.Point((float)(Margin.Left + ReferenceBorder.Margin.Left + Width), (float)(Margin.Top + ReferenceBorder.Margin.Top))
            };

        line.Point = new Tools.SnapIt.Common.Graphics.Point(line.Start.X, line.Start.Y);
        line.SplitDirection = SplitDirection;
        line.Size = new Tools.SnapIt.Common.Graphics.Size(
