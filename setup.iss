...
; Note: settings\opencode\models.json and settings\opencode\templates\* are app-authored
; (the shipped copy is authoritative and refreshed into %USERPROFILE%\.devtools at run),
; so they are NOT excluded here and are always replaced on upgrade via this catch-all.
